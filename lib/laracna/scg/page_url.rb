module Laracna
  module Scg
    class PageUrl
      ...
      DECK_LIST_URL = "/deckdatabase/deckshow.php?&t%5BC1%5D=1&start_date=01/01/2015&end_date=#{Time.zone.now.strftime("%m/%d/%y")}&limit=100&order_1=date+desc&order_2=date+desc"
